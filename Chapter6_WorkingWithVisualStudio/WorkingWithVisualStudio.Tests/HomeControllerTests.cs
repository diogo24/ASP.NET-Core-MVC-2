using Chapter6_WorkingWithVisualStudio.Controllers;
...
namespace WorkingWithVisualStudio.Tests
{
    public class HomeControllerTests
    {
        ...
        class ModelCompleteFakeRepository_WithParameterization : IRepository
        {
        ...
        public void IndexActionModelIsComplete_WithParameterization(decimal price1, decimal price2,
        decimal price3, decimal price4)
        {
            // Arrange
            var controller = new HomeController();
            controller.Repository = new ModelCompleteFakeRepository_WithParameterization
            {
        ...
        public void IndexActionModelIsComplete_ProductTestDataIEnumerable(Product[] products)
        {
            // Arrange
